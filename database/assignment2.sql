-- Criação do tipo ENUM para account_type
DO $$
BEGIN
...
-- Dados iniciais para classification
...
INSERT INTO public.inventory (
    ...
    ('GM', 'Hummer', '2016', 'Do you have 6 kids and like to go offroading? The Hummer gives you a huge interior with an engine to get you out of any muddy or rocky situation.', '/images/hummer.jpg', '/images/hummer-tn.jpg', 58800, 56564, 'Yellow', 4),
...
-- Update Tony Stark (exemplo: mudar account_type para 'Admin')
...
-- Update descrição do inventário (inv_id 10)
UPDATE public.inventory
SET inv_description = REPLACE(inv_description, 'small interiors', 'a huge interior')
WHERE inv_id = 10;

-- SELECT com JOIN correto (classification)
...
-- Comandos extras só se desejar (não obrigatórios para o assignment):
-- UPDATE public.account SET account_type = 'Admin' WHERE account_firstname = 'Manager';
-- DELETE FROM public.classification WHERE classification_id = 6;
-- DELETE FROM public.classification WHERE classification_id = 7;
